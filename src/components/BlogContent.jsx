    ...
    <>
      <div className="min-h-screen bg-gray-900 text-gray-100 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <button
            className="mb-4 flex items-center space-x-2 px-4 py-2 rounded-full bg-gray-800 text-gray-300 hover:text-yellow-400 transition-colors"
            onClick={() => navigate(-1)}
          >
            <ArrowLeft size={18} />
            <span>Back</span>
          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-6 overflow-hidden relative">
            ...
            <div className="flex justify-center mt-4">
              <button
                ...
                className="flex items-center space-x-2 px-6 py-2 rounded-full bg-yellow-600 text-white border border-yellow-500 hover:bg-yellow-700 transition-colors"
              >
